...
@test "test vault-manager manage policies" {
    ...
    [[ "${output}" == *"[Vault Policy] policy successfully written to Vault instance"*"name=app-sre-policy"* ]]
    [[ "${output}" == *"[Vault Policy] policy successfully written to Vault instance"*"name=app-interface-approle-policy"* ]]
