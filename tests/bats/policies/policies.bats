...
@test "test vault-manager manage policies" {
    ...
    [[ "${output}" == *"[Vault Policy] policy successfully written to Vault instance"*"instance=\"http://127.0.0.1:8200\""*"name=app-interface-approle-policy"* ]]
    [[ "${output}" == *"[Vault Policy] policy successfully written to Vault instance"*"instance=\"http://127.0.0.1:8202\""*"name=app-sre-policy"* ]]
    [[ "${output}" == *"[Vault Policy] policy successfully written to Vault instance"*"instance=\"http://127.0.0.1:8202\""*"name=app-interface-approle-policy"* ]]
