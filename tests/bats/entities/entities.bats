...
@test "test vault-manager manage entities and aliases" {
    ...
    [[ "${output}" == *"[Vault Identity] entity successfully written"*"instance=\"http://primary-vault:8200\""*"path=identity/entity/name/tester"*"type=entity"* ]]
    [[ "${output}" == *"[Vault Identity] entity alias successfully written"*"instance=\"http://primary-vault:8200\""*"path=identity/entity-alias/tester"*"type=oidc"* ]]
    [[ "${output}" == *"[Vault Identity] entity successfully written"*"instance=\"http://secondary-vault:8202\""*"path=identity/entity/name/tester"*"type=entity"* ]]
    [[ "${output}" == *"[Vault Identity] entity alias successfully written"*"instance=\"http://secondary-vault:8202\""*"path=identity/entity-alias/tester"*"type=oidc"* ]]
