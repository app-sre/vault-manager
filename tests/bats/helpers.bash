setup() {
  ...
  docker run -d --net=host -v /var/run/docker.sock:/var/run/docker.sock --name="vault-dev-server" --cap-add=IPC_LOCK -e 'VAULT_DEV_ROOT_TOKEN_ID=root' -p 8200:8200 -v /tmp/:/var/log/vault/:Z vault:1.5.4
