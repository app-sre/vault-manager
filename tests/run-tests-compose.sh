...
podman-compose exec vault-manager-test bats --tap tests/bats/roles/roles.bats

# entities is dependent on config generated by other tests
echo "running bats/entities/entities.bats"
podman-compose exec vault-manager-test bats --tap tests/bats/entities/entities.bats

# groups is dependent on entities
echo "running bats/groups/groups.bats"
podman-compose exec vault-manager-test bats --tap tests/bats/groups/groups.bats

# run error handling test now that vaults are fully configured
echo "running bats/errors/errors.bats"
podman-compose exec vault-manager-test bats --tap tests/bats/errors/errors.bats
